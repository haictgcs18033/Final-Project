...
export default function UserProfile() {
  ...
  let validation = () => {
    ...
    if (
      userDetail.firstName.startsWith(" ") ||
      userDetail.firstName.endsWith(" ")
    ) {
    ...
    if (
      userDetail.lastName.startsWith(" ") ||
      userDetail.lastName.endsWith(" ")
    ) {
        ...
        <div className={classes.accountDetail}>
          <div className={`${classes.accountForm}`}>
            ...
            <div className={`form-group`}>
              ...
              />
              {error.email ? (
                <p style={{ color: "red", margin: "10px 0" }}>{error.email}</p>
              ) : (
                ""
              )}
            </div>
  ...
  return (
    <div>
      ...
      <div
        className={`container userProfileMobile ${classes.userProfileMobile}`}
      >
        <div>
